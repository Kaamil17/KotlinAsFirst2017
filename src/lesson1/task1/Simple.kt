 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int) = (sagenes * 48 * 4.445 + arshins * 16 * 4.445 + vershoks * 4.445) / 100
 ...
 */
fun angleInRadian(grad: Int, min: Int, sec: Int): Double =((grad + min/60.0 + sec/3600.0 )/180.0)*3.1415926535
...
fun travelMinutes(hoursDepart: Int, minutesDepart: Int, hoursArrive: Int, minutesArrive: Int): Int {
    ...
    val minutes = (hoursArrive * 60 + minutesArrive) - (hoursDepart * 60 + minutesDepart)
    return minutes
    }
